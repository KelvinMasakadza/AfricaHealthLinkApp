...
public class DrugListItemBindingImpl extends DrugListItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.add_drug, 4);
    }
    // views
    @NonNull
    ...
    public DrugListItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private DrugListItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
