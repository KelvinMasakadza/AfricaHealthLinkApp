...
public class ActivitySignInBindingImpl extends ActivitySignInBinding implements com.africahealthlinkapp.e_treat.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.activity == variableId) {
            setActivity((com.africahealthlinkapp.e_treat.SignInActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.africahealthlinkapp.e_treat.SignInActivity Activity) {
    ...
    protected void executeBindings() {
        ...
        com.africahealthlinkapp.e_treat.SignInActivity activity = mActivity;
        // batch finished
