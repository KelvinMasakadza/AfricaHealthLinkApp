...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYPATIENT = 6;

  private static final int LAYOUT_ACTIVITYPHARMACYDETAIL = 7;

  private static final int LAYOUT_ACTIVITYPROFILE = 8;

  private static final int LAYOUT_ACTIVITYSEARCHDOCTOR = 9;

  private static final int LAYOUT_ACTIVITYSIGNIN = 10;

  private static final int LAYOUT_ACTIVITYSIGNUP = 11;

  private static final int LAYOUT_APPOINTMENTSMODEL = 12;

  private static final int LAYOUT_CART = 13;

  private static final int LAYOUT_DOCTORMODEL = 14;

  private static final int LAYOUT_DOCTORSMODEL = 15;

  private static final int LAYOUT_DRUGLISTITEM = 16;

  private static final int LAYOUT_INFOMODEL = 17;

  private static final int LAYOUT_PATIENTMODEL = 18;

  private static final int LAYOUT_REACHOUT = 19;
