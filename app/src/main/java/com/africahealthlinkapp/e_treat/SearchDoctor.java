...
//        });
    ...
    private void getClosestDoctor() {
        DatabaseReference doctorsAvailable = FirebaseDatabase.getInstance().getReference().child("doctorsAvailable");

        GeoFire geoFire = new GeoFire(doctorsAvailable);
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!doctorFound && requestBol) {
                    DatabaseReference mPatientDatabase = FirebaseDatabase.getInstance().getReference().child("users").child("doctors").child(key);
